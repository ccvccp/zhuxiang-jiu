...
from repositories.cooperation_repository import (
    ...
    # 合作方类型
    QUAL_STATUS_PENDING, QUAL_STATUS_APPROVED, QUAL_STATUS_REJECTED, PARTNER_LEVEL_BRONZE, PARTNER_STATUS_PENDING, PARTNER_STATUS_ACTIVE, PARTNER_STATUS_SUSPENDED, PARTNER_STATUS_TERMINATED,
    # 申请类型
    APP_STATUS_PENDING, APP_STATUS_REVIEWING, APP_STATUS_APPROVED,
    APP_STATUS_REJECTED, APP_STATUS_SIGNED, CONTRACT_STATUS_ACTIVE,
