...
# 注: 余额收益率微调(2026-09-16)——6 个月 5%→3.5%,
#     修复档位倒挂(原 6 个月余额收益高于 12/24 个月,
#     保证收益口径下 6 个月循环续存套利 5% > 24 个月 3.5%);
#     调整后 6 个月综合年化(余额 35 + 奖品 88)/2000 ≈ 12.3%,
#     留出 LPR 合规安全余量
DEPOSIT_TIERS = {
    3:  {"min": 1000.0,  "rate": 0.030, "hasReward": False},
    6:  {"min": 2000.0,  "rate": 0.035, "hasReward": True},
