...
# 注: 余额收益率单调递增序列(2026-09-16 业务方核定)——
#     3%→3.3%→3.5%→3.8%(修复原 6 个月 5% 倒挂);
#     已知影响(业务方接受): 12 个月 3.5% 使 ¥5,000 主推档
#     综合收益率(175+536)/5000=14.22% 超 LPR 4倍(13.8%),
#     转定期时触发合规自动降档——该档奖品取消
#     (余额收益 3.5% 保留, 详见 _check_lpr_compliance)
DEPOSIT_TIERS = {
    3:  {"min": 1000.0,  "rate": 0.030, "hasReward": False},
    6:  {"min": 2000.0,  "rate": 0.033, "hasReward": True},
    12: {"min": 5000.0,  "rate": 0.035, "hasReward": True},
    24: {"min": 10000.0, "rate": 0.038, "hasReward": True},
}
