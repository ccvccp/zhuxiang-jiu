...
from repositories.points_repository import (
    PointsRepository,
    # 流水类型
    LOG_TYPE_EARN, LOG_TYPE_SPEND, LOG_TYPE_FREEZE, LOG_TYPE_UNFREEZE,
    # 流水来源
    SOURCE_CHECKIN, SOURCE_ORDER, SOURCE_REFERRAL, SOURCE_CREDIT,
    SOURCE_REVIEW, SOURCE_TRANSACTION, SOURCE_PROMO,
    SOURCE_REFUND, SOURCE_EXPIRE, SOURCE_DEDUCT,
    # 流水状态
    LOG_STATUS_FROZEN, LOG_STATUS_AVAILABLE, LOG_STATUS_EXPIRED, LOG_STATUS_CONSUMED,
    # 过期批次状态
