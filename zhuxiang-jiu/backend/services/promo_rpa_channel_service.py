"""36号·RPA 发布通道服务(创作者中心浏览器自动化·多平台)

背景(2026-09-26 小红书立项 / 2026-09-27 抖音图文接入):
官方 API 均无第三方内容发布能力——小红书(企业资质也只开放
广告/商品数据)、抖音(视频发布需企业主体开放平台认证)。
创作者中心网页版浏览器自动化是现实最优路径(个人号即可,
业界主流方案): 小红书 creator.xiaohongshu.com 发图文笔记;
抖音 creator.douyin.com 发图文(个人号网页版支持, 免企业
资质与视频生产线)。

架构: 旁路闭环——发布队列出队时 RPA 平台内容回 rpa_pending
