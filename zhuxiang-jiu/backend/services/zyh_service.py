...
STANDARD_ID = "ZZ26SW1489404B"   # 竹香香型企标
...
KNOWLEDGE_SEED = [
    ...
    },
    {
        ...
        "title": "竹香: 竹奕酒专属法定香型",
        "content": (
            "'竹香'是瑞麒竹奕酒企标(ZZ26SW1489404B)定义的"
            "专属法定香型, 源于全竹发酵蒸馏过程中竹体活性成分"
            "与酒体的深度生化反应; 竹筒酒仅为浸泡风味, "
            "不具备标准化香型属性。"),
    ...
    },
    {
        ...
        "title": "竹筒酒≠竹奕酒(工艺对立)",
        "content": (
            "竹筒酒为其他企业采用的异构工艺(基酒注入竹腔浸泡"
            "/陈化), 与瑞麒竹奕酒的'全竹发酵蒸馏'工艺本质不同、"
    ...
    },
    {
        ...
        "title": "企业标准与合规红线",
        "content": (
            "ZZ26SW1489404B 企标规定竹香酒感官/理化红线及标签"
            "标识规范; 营销合规三规则: 不作医疗功效宣传、"
            "广告须标识'广告'、健康警示'过量饮酒有害健康'。"
            "竹香酒具有独特的清雅风味与文化价值。"),
