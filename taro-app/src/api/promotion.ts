...
export const PromoAPI = {
  ...
  async stats(): Promise<PromotionStatsVO> {
    ...
    return {
      ...
      level1Threshold: res.level1Threshold || 10,
      level1RewardAmount: res.level1RewardAmount || 20,
      level2SubPromoterCount: res.level2SubPromoterCount || 6,
      level2SubThreshold: res.level2SubThreshold || 5,
      level2RewardAmount: res.level2RewardAmount || 15,
